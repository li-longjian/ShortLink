package org.llj.shortlink.admin.remote;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import org.llj.shortlink.admin.common.convention.result.Result;
import org.llj.shortlink.admin.remote.dto.req.*;
import org.llj.shortlink.admin.remote.dto.resp.*;
...
public interface ShortLinkActualRemoteService {
     ...
     * @return 短链接批量创建响应
     */
    @PostMapping("/api/shortlink/v1/link/create/batch")
    ...
    Result<Page<ShortLinkPageRespDTO>> pageShortLink(@RequestParam("gid") String gid,
                                                     ...
                                                     @RequestParam("size") Long size);//可以使用@SpringQueryMap
     ...
     * @return 短链接监控访问记录信息
     */
    @GetMapping("/api/shortlink/v1/stats/stats-record")
     ...
     */
    @GetMapping("/api/shortlink/v1/stats/stats-record/group")
